...
| M3-06 | Prebuilt-binary distribution (hash + attestation + ABI) | ✅ | Release | §7.3 | §9.4 | Build hook downloads, hash-verifies, and attestation-verifies a real artifact end-to-end |
...
- **EPIC-M3** — P2 domains (M3-03 disks ✅; M3-04 network ✅; M3-05 permission lint ✅; M3-06 prebuilts ✅), domain generator ✅, dartdoc/ABI CI gates.
